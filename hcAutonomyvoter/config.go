...
const (
	defaultConfigFilename   = "hcAutonomyvoter.conf"
	defaultLogLevel         = "info"
	defaultLogDirname       = "logs"
	defaultLogFilename      = "hcAutonomyvoter.log"
	...
	defaultWalletTestnetPort = "12011"
)

var (
	defaultHomeDir        = hcutil.AppDataDir("hcAutonomyvoter", false)
...
type config struct {
	...
	HcAutonomyWWW      string `long:"hcAutonomywww" description:"HcAutonomy WWW host"`
...
func loadConfig() (*config, []string, error) {
	...
	if cfg.HcAutonomyWWW == "" {
		if activeNetParams.Name == "mainnet" {
			//cfg.HcAutonomyWWW = "https://proposals.HcashOrg.org/api"
			cfg.HcAutonomyWWW = "https://localhost:3000/api"
		} else {
			cfg.HcAutonomyWWW = "https://localhost:3000/api"
		}
	}
