...
```
dep ensure
go install -v ./... && LOGFLAGS=shortfile hcAutonomyd --testnet --rpcuser=user --rpcpass=pass --gittrace
```

Install hcAutonomy
```
cd hcAutonomyd/cmd/hcAutonomy
go install
```
...
+ hcAutonomy -v -testnet -rpchost 127.0.0.1 new '{"name":"Marco", "description":"Bad bug #1"}' badbug1.txt
