...
// for hcd and other utilities provided in the same repository.
package version
...
var (
	...
	// build process with:
	// '-ldflags "-X github.com/HcashOrg/hcAutonomy/util/version.PreRelease=foo"'
	...
	// build process with:
	// '-ldflags "-X github.com/HcashOrg/hcAutonomy/util/version.BuildMetadata=foo"'
