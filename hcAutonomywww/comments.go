...
// _convertHcCommentToWWWComment converts HcashOrg plugin comment to www comment.
//
// Must be called WITH the lock held.
func (b *backend) _convertHcCommentToWWWComment(c HcashOrgplugin.Comment) www.Comment {
	return www.Comment{
		Token:       c.Token,
		ParentID:    c.ParentID,
		Comment:     c.Comment,
...
func convertWWWCommentToHcComment(c www.Comment) HcashOrgplugin.Comment {
	return HcashOrgplugin.Comment{
		Token:       c.Token,
		ParentID:    c.ParentID,
		Comment:     c.Comment,
		Signature:   c.Signature,
...
func convertWWWNewCommentToHcNewComment(nc www.NewComment) HcashOrgplugin.NewComment {
	return HcashOrgplugin.NewComment{
		Token:     nc.Token,
...
// convertHcNewCommentReplyToWWWNewCommentReply converts HcashOrg plugin new
// comment to www new comment.
//
// Must be called WITHOUT the lock held.
func (b *backend) convertHcNewCommentReplyToWWWNewCommentReply(cr HcashOrgplugin.NewCommentReply) www.NewCommentReply {
	b.RLock()
	defer b.RUnlock()
	return www.NewCommentReply{
		Comment: b._convertHcCommentToWWWComment(cr.Comment),
	}
}

func convertWWWLikeCommentToHcLikeComment(lc www.LikeComment) HcashOrgplugin.LikeComment {
	return HcashOrgplugin.LikeComment{
		Token:     lc.Token,
...
func convertHcLikeCommentToWWWLikeComment(lc HcashOrgplugin.LikeComment) www.LikeComment {
...
func convertHcLikeCommentReplyToWWWLikeCommentReply(lcr HcashOrgplugin.LikeCommentReply) www.LikeCommentReply {
...
func convertWWWCensorCommentToHcCensorComment(cc www.CensorComment) HcashOrgplugin.CensorComment {
	return HcashOrgplugin.CensorComment{
		Token:     cc.Token,
...
func convertHcCensorCommentReplyToWWWCensorCommentReply(ccr HcashOrgplugin.CensorCommentReply) www.CensorCommentReply {
