...
const (
	fromAddress      = "autonomy@h.cash"
	hcAutonomyMailName = "HcAutonomy"
)
...
func (b *backend) sendEmail(
	...
	msg := goemail.NewHTMLMessage(fromAddress, subject, body)
	...
	msg.SetName(hcAutonomyMailName)
	err = b.cfg.SMTP.Send(msg)
