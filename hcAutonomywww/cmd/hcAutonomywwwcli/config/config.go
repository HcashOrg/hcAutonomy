...
const (
	...
	defaultConfigFilename    = "hcAutonomywwwcli.conf"
	defaultHost              = "https://proposals.HcashOrg.org/api"
	defaultFaucetHost        = "https://faucet.HcashOrg.org/requestfaucet"
...
type Config struct {
	...
	Host        string `long:"host" description:"hcAutonomywww host"`
...
//
// The above results in hcAutonomywwwcli functioning properly without any config
