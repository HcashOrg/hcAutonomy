...
func (c *Client) makeRequest(method, route string, body interface{}) ([]byte, error) {
	...
	fullRoute := c.cfg.Host + v1.HcAutonomyWWWAPIRoute + route + queryParams
...
func (c *Client) Version() (*v1.VersionReply, error) {
	fullRoute := c.cfg.Host + v1.HcAutonomyWWWAPIRoute + v1.RouteVersion
...
func (c *Client) Login(l *v1.Login) (*v1.LoginReply, error) {
	...
	fullRoute := c.cfg.Host + v1.HcAutonomyWWWAPIRoute + v1.RouteLogin
...
func (c *Client) Logout() (*v1.LogoutReply, error) {
	fullRoute := c.cfg.Host + v1.HcAutonomyWWWAPIRoute + v1.RouteLogout
