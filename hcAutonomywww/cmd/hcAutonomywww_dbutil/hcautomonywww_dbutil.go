...
var (
	addCredits = flag.Bool("adhcedits", false, "Add proposal credits to a user's account. Parameters: <email> <quantity>")
	dataDir    = flag.String("datadir", sharedconfig.DefaultDataDir, "Specify the hcAutonomywww data directory.")
	dumpDb     = flag.Bool("dump", false, "Dump the entire hcAutonomywww database contents or contents for a specific user. Parameters: [email]")
