...
const (
	...
	defaultConfigFilename         = "hcAutonomywww_dataload.conf"
	defaultHcAutonomydLogFilename   = "hcAutonomyd.log"
	defaultHcAutonomywwwLogFilename = "hcAutonomywww.log"
...
// config defines the configuration options for hcAutonomywww_dataload.
//
...
type config struct {
	...
	DeleteData          bool   `long:"deletedata" description:"Delete all existing data from hcAutonomyd and hcAutonomywww before loading data"`
	HcAutonomydLogFile    string
	HcAutonomywwwLogFile  string
}
...
func loadConfig() (*config, error) {
	...
	cfg.HcAutonomydLogFile = filepath.Join(cfg.DataDir,
		defaultHcAutonomydLogFilename)
	cfg.HcAutonomywwwLogFile = filepath.Join(cfg.DataDir,
		defaultHcAutonomywwwLogFilename)
