...
import (
	...
	"github.com/HcashOrg/hcAutonomy/hcAutonomywww/database"
	"github.com/HcashOrg/hcAutonomy/util"
	"github.com/HcashOrg/hcAutonomy/util/version"
...
// hcAutonomywww application context.
type hcAutonomywww struct {
	cfg    *config
	router *mux.Router
...
func (p *hcAutonomywww) getSession(r *http.Request) (*sessions.Session, error) {
	return p.store.Get(r, v1.CookieSession)
}

// getSessionEmail returns the email address of the currently logged in user
// from the session store.
func (p *hcAutonomywww) getSessionEmail(r *http.Request) (string, error) {
...
func (p *hcAutonomywww) getSessionUser(w http.ResponseWriter, r *http.Request) (*database.User, error) {
...
func (p *hcAutonomywww) setSessionUser(w http.ResponseWriter, r *http.Request, email string) error {
...
func (p *hcAutonomywww) removeSession(w http.ResponseWriter, r *http.Request) error {
...
func (p *hcAutonomywww) isAdmin(w http.ResponseWriter, r *http.Request) (bool, error) {
...
func (p *hcAutonomywww) getIdentity() error {
	...
	log.Infof("Identity fetched from hcAutonomyd")
	...
	if pdError, ok := args[0].(v1.PDError); ok {
		...
		if pdErrorCode == v1.ErrorStatusInvalid {
			...
			log.Errorf("%v %v %v %v Internal error %v: error "+
				"code from hcAutonomyd: %v", remoteAddr(r),
...
func (p *hcAutonomywww) handleVersion(w http.ResponseWriter, r *http.Request) {
	log.Tracef("handleVersion")

	versionReply, err := json.Marshal(v1.VersionReply{
		Version: v1.HcAutonomyWWWAPIVersion,
		Route:   v1.HcAutonomyWWWAPIRoute,
...
func (p *hcAutonomywww) handleNewUser(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleVerifyNewUser(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleResendVerification(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleUpdateUserKey(w http.ResponseWriter, r *http.Request) {
...
// that the user with the provided email has a verification token that matches
// the provided token and that the verification token has not yet expired.
func (p *hcAutonomywww) handleVerifyUpdateUserKey(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleLogin(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleLogout(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleSecret(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleMe(w http.ResponseWriter, r *http.Request) {
	log.Tracef("handleMe")
...
func (p *hcAutonomywww) handleChangeUsername(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleChangePassword(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleResetPassword(w http.ResponseWriter, r *http.Request) {
	...
	if err := decoder.Decode(&rp); err != nil {
		if err.Error() != "250 Data Ok: queued as freedom"{
...
func (p *hcAutonomywww) handleProposalPaywallDetails(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleProposalPaywallPayment(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleNewProposal(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleSetProposalStatus(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleProposalDetails(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handlePolicy(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleAllVetted(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleAllUnvetted(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleNewComment(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleLikeComment(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleCensorComment(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleCommentsGet(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleVerifyUserPayment(w http.ResponseWriter, r *http.Request) {
...
// the logged in user.
func (p *hcAutonomywww) handleUserProposalCredits(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleUserPaymentsRescan(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleUserProposals(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleActiveVote(w http.ResponseWriter, r *http.Request) {
...
// handleCastVotes records the user votes in hcAutonomyd.
func (p *hcAutonomywww) handleCastVotes(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleVoteResults(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleAuthorizeVote(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleStartVote(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleUserDetails(w http.ResponseWriter, r *http.Request) {
	// Add the path param to the struct.
...
func (p *hcAutonomywww) handleUsers(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleManageUser(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleEditUser(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleGetAllVoteStatus(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleVoteStatus(w http.ResponseWriter, r *http.Request) {
	pathParams := mux.Vars(r)
...
func (p *hcAutonomywww) handleUserCommentsLikes(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleEditProposal(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleProposalsStats(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) handleNotFound(w http.ResponseWriter, r *http.Request) {
...
func (p *hcAutonomywww) addRoute(method string, route string, handler http.HandlerFunc, perm permission, shouldLoadInventory bool) {
	fullRoute := v1.HcAutonomyWWWAPIRoute + route
...
func _main() error {
	...
	if loadedCfg.PaywallAmount != 0 && loadedCfg.PaywallXpub != "" {
		paywallAmountInHc := float64(loadedCfg.PaywallAmount) / 1e8
		log.Infof("Paywall : %v HC", paywallAmountInHc)
	...
	if !fileExists(loadedCfg.HTTPSKey) &&
		...
		err := util.GenCertPair(elliptic.P256(), "hcAutonomydwww",
