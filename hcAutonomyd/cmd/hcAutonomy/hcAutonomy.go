...
var (
	...
	defaultHomeDir          = hcutil.AppDataDir("hcAutonomy", false)
...
func usage() {
	fmt.Fprintf(os.Stderr, "usage: hcAutonomy [flags] <action> [arguments]\n")
...
// hcAutonomyd, which will contain a JSON error.
