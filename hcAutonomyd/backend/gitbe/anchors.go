...
// merkle root, that get checkpointed in hctime. This provides censorship
// resistance by anchoring activity on hcAutonomy to the blockchain.
//
// To help process anchors, we need to look up the last anchor and unconfirmed anchors that
// have not been checkpointed in hctime yet. To identify these, we parse the
...
// LastAnchor stores the last commit anchored in hctime.
